...
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(60, 35))
...
ax1.legend(prop={'size': 80})
ax1.grid()
ax1.set_ylabel('Coefficient of Determination',fontsize=80)
ax1.set_xlabel('Case study and samplerates',fontsize=80)

ax2.plot(namelist,rmselist,linewidth=15)    
ax2.set_xticklabels(namelist, rotation=60, ha='right')
ax2.grid()
ax2.set_ylabel('RSME (mm)',fontsize=80)
ax2.set_xlabel('Case study and samplerates',fontsize=80)    
plt.savefig('SVR_samplerate.png', dpi=150)     